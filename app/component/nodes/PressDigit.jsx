...
const PressDigit = memo(({ data, id }) => {
  ...
  const [headingText, setHeadingText] = useState("Press Digit");
  ...
  return (
    <>
      ...
      <div
        className={`relative bg-[#f0fdfa] p-2 rounded-md shadow-sm min-w-[300px] ${
          selected ? "border-2 border-blue-500" : ""
        }`}
        onClick={() => setSelected(!selected)}
      >
        {/* Header */}
        <div className="px-3 py-2 bg-[#f0fdfa]">
          <div className="flex justify-between items-center">
            <div className="flex gap-1 items-center">
              <FaHashtag className="text-green-800" size={15} />
              {isEditHeading ? (
                <input
                  type="text"
          ...
          <div className="flex justify-between text-gray-400 items-center">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem
                  onClick={() => handleAddTransition("Equation")}
                >
                  <BiMath /> Equation
                </DropdownMenuItem>
              </DropdownMenuContent>
